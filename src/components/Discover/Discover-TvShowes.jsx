...
export default function DiscoverTvShows() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(
      `https://api.themoviedb.org/3/discover/tv?api_key=c04c56b8aeb3dce3acdfd16eb3ca314b&language=en-US&${sortBy}&include_adult=false&include_video=false&page=${page}&${releaseYear}${genreid}&with_watch_monetization_types=flatrate`,
      options
    )
