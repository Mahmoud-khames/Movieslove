...
import { fetchTvpopular } from "../Redux/tv-slice-popular";
import { Link } from 'react-router-dom';

export default function TvPopular() {
  
  let tvpopular = useSelector((state) => state.tvpopular);
    ...
    <div className="topmovies">
        <div className="row">
            ...
            <a href="/#" className="text-decoration-none ms-2">
                <h2>Popular TV Shows <span className="span">Explore All <i className="fa-solid fa-angles-right"></i></span></h2>
            </a>
            </div>
          {Array.isArray(tvpopular)&& (
            <Swiper
